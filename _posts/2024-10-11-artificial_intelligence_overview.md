...
下面是一个简单的逻辑回归示例的结果
<video src="https://millexi.github.io/images/download.mp4" controls="controls" width="500" height="300"></video>

*相关逻辑回归演示代码：*
- [github]<https://github.com/MilleXi/MilleXi.github.io/logistic_regression_code.ipynb> 
or
- [kaggle]<https://www.kaggle.com/code/millexi/logistic-regression>
